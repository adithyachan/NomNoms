...
export default function CreateJoinTableTabs(props: { activeTab: string | null, setActiveTab: Dispatch<SetStateAction<string | null>> }) {
  return (
    <Tabs color="red" value={props.activeTab} onTabChange={props.setActiveTab} className="min-w-full mx-10 bg-gradient-to-r from-red-200 to-red-200 via-red-100 shadow-red-100 rounded-3xl p-10 shadow-md transition ease-in-out hover:shadow-xl hover:shadow-red-300 duration-300">
