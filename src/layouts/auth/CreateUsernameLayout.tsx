...
export default function AuthenticationForm(props: PaperProps) {
  ...
  //disable the button if the inputs are not valid
    const HandleCreate = async (e: any) => {
      ...
      const usernameC = users?.find((item) => item.username == username)
